...
RSpec.describe 'Reservations', type: :model do
  subject do
    ...
    Product.create(id: 3, name: 'Model X', image: 'https://hips.hearstapps.com/hmg-prod/amv-prod-cad-assets/wp-content/uploads/2016/05/2016-Tesla-Model-X-101-1-626x383.jpg', price: 68_000.00, description:
